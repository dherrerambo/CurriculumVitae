...
\usepackage[
    pdftitle= Diego Ernesto Herrera Malambo,
    pdfauthor= Diego Ernesto Herrera Malambo,
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Diego Ernesto Herrera Malambo - Pagina \thepage{} de \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        \textbf{\fontsize{24 pt}{24 pt}\selectfont Diego Ernesto Herrera Malambo}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\color{black}\footnotesize\faMapMarker*}\hspace*{0.13cm} \hrefWithoutArrow{https://es.wikipedia.org/wiki/Cartagena_de_Indias}{Cartagena (CO)}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{{\color{black}\footnotesize\faEnvelope[regular]}\hspace*{0.13cm} \hrefWithoutArrow{mailto:dherrerambo@gmail.com}{dherrerambo@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{{\color{black}{\footnotesize\faPhone*}\hspace*{0.13cm}\hrefWithoutArrow{tel:(+57)3105356095}{(57)310 535 60 95}}}%
        \kern 0.25 cm%
        %\AND%
        %\kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.13cm}\hrefWithoutArrow{https://www.linkedin.com/in/dherrerambo/}{dherrerambo}}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{{\color{black}{\footnotesize\faGithub}\hspace*{0.13cm}\hrefWithoutArrow{https://github.com/dherrerambo}{dherrerambo}}}%
    \end{header}

    \vspace{0.5 cm - 0.5 cm}
